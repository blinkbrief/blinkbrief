...
## 🧠 How It Works
BlinkBrief uses an AI summarization model to:
1. Fetch articles from your selected sources  
2. Extract key content  
3. Generate short, digestible summaries  

All summaries stay local to your device — your data, your control.  
